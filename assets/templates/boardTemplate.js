...
function displayTasks(board, tasks, contacts) {
    ...
    Object.keys(board.tasks).forEach((taskId) => {
        ...
        htmlContent += `
            <div onclick="toggleTaskDetails('${taskId}')" class="board-task-container" draggable="true" ondragstart="startTaskDragging('${board.id
            }', '${taskId}')">
                ...
                <div class="board-task-footer d-flex justify-content-between">
                    ...
                    <img class="board-task-category" src="./assets/icons/prio-${task.prio
            }.svg" alt="">
                </div>
            </div>
        `;
