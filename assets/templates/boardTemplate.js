function displayBoardContainer(board) {
    let addTaskContent = board.addtasks ? `<div onclick="toggleAddTaskOverlay()" class="board-container-titlebox-addtask d-flex justify-content-center align-items-center">+</div>` : "";
    return `
...
function displayContact(contact) {
    return `
        <div class="task-contact f11" style="background: ${contact.avatarColor}">${getShortcutName(contact)}</div >
        `;
}
